module Spree
  class PaymentMethodTransactionsReport < Spree::Report
    ...
    def generate
      payments = SpreeAdminInsights::ReportDb[:spree_payment_methods___payment_methods].
      ...
      where(payments__created_at: @start_date..@end_date).
      where(payments__state: 'completed'). #filter by params
      ...
      group(:year, :number, :months_name, :payment_method_name).
      order(:year, :number).
      select{[
        number,
        payment_method_name,
        ...
        charts: [
          {
            ...
            json: {
              ...
              title: {
                useHTML: true,
                text: "<span class='chart-title'>Payment Methods</span><span class='glyphicon glyphicon-question-sign' data-toggle='tooltip' title=' Compare the revenue generated by different Payment methods such as CC, Check etc.'></span>"
              },
