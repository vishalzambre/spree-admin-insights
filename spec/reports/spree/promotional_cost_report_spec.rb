...
describe Spree::PromotionalCostReport do
  ...
  let(:report) { Spree::PromotionalCostReport.new(search_params) }
  ...
  describe '#initialize' do
    ...
    it { expect(report.sortable_attribute).to eq(:promotion_name) }
  end
